...
import MateriLingkungan from '@/pages/public/materi/MateriLingkungan'

const TRAINING_CODE = 'KESADARAN_LINGKUNGAN'

const QUIZ_CONFIG = {
  code: TRAINING_CODE,
  title: 'Quiz Kesadaran Lingkungan',
  subtitle: 'Manajemen Lingkungan & Bahan Kimia',
} as const

type Phase = 'nik' | 'pretest' | 'materi' | 'posttest'

export default function KesadaranLingkunganQuiz() {
